        ...
        if command == 1 or command == 2:
            ...
            if command == 1:
                ...
                for index in range(len(filenames)):
                    if (filenames[index][0] == 'P') or (filenames[index][0] == 'M'):
                        ...
                        plt.annotate(filenames[index], (x[index], y[index]))
                    elif (filenames[index][0] == 'X') or (filenames[index][0] == 'L'):
            ...
            for index in range(len(g1)):
                axs[index].bar(1 - width, g1[index] - bottom[index], width=0.3, bottom=bottom[index],
                               ...
                               linewidth=0.1)
                for sample in g2:
                    axs[index].bar(1 + width*int(g2.index(sample)), sample[index] - bottom[index], width=0.3,
                                   bottom=bottom[index], yerr=error_p[index],
                               ecolor="black", alpha=0.6, color='r', edgecolor="blue", linewidth=0.1)
                for sample in g3:
                    axs[index].bar(1 + width * (len(g2) + int(g3.index(sample))), sample[index] - bottom[index],
                                width=0.3, bottom=bottom[index], yerr=error_p[index], ecolor="black", alpha=0.6,
                                color='b', edgecolor="blue", linewidth=0.1)
...
def main_menu():
    command = int(input('***** PCA (Python3 + R) v5.0 от dzagalskij X daniil432 *****\n' +
